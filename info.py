...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002223245236').split()]
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002236655925')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://user2607:akfronik26@cluster0.m3hxy.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'iraunak@pnb')

# for stream
IS_STREAM = is_enabled('IS_STREAM', True)
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002404017863")
